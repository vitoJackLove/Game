...
namespace GameFramework.DataTable
{
    ...
    public class DefaultDataTableHelper : DataTableHelperBase
    {
        ...
        private ResourcesComponent m_ResourceComponent = null;
        ...
        protected override bool LoadDataTable(Type dataRowType, string dataTableName, string dataTableNameInType, object dataTableAsset, LoadType loadType, object userData)
        {
            ...
            if (textAsset == null)
            {
                Debug.LogWarning($"Data table asset '{dataTableName}' is invalid.");
                return false;
            }

            if (dataRowType == null)
            {
                Debug.LogWarning("Data row type is invalid.");
                return false;
            }
            ...
            switch (loadType)
            {
                ...
                default:
                    Debug.LogWarning("Unknown load type.");
                    return false;
            }
        ...
        public override void Init(DataTableComponent component , ResourcesComponent resource)
        {
            m_DataTableComponent = component;
            if (m_DataTableComponent == null)
            {
                Debug.LogError("Data table component is invalid.");
                return;
            }

            m_ResourceComponent = resource;
